...
__all__ = ['get_subs', 'get_bfiles_tuple', 'get_sub_gradfiles', 'PipetographyBaseInputSpec', 'aff2rigidInputSpec',
           'aff2rigidOutputSpec', 'fslaff2rigid', 'ConvertInputSpec', 'ConvertOutputSpec', 'Convert',
           'GradCheckInputSpec', 'GradCheckOutputSpec', 'GradCheck', 'dwidenoiseInputSpec', 'dwidenoiseOutputSpec',
           'dwidenoise', 'dwipreprocInputSpec', 'dwipreprocOutputSpec', 'dwipreproc', 'BiasCorrectInputSpec',
           'BiasCorrectOutputSpec', 'BiasCorrect', 'MRInfoInputSpec', 'MRInfoOutputSpec', 'MRInfo', 'CheckNIZInputSpec',
           'CheckNIZOutputSpec', 'CheckNIZ', 'RicianNoiseInputSpec', 'RicianNoiseOutputSpec', 'RicianNoise',
           'MRThresholdInputSpec', 'MRThresholdOutputSpec', 'MRThreshold', 'DWINormalizeInputSpec',
           'DWINormalizeOutputSpec', 'DWINormalize', 'TransConvertInputSpec', 'TransConvertOutputSpec', 'TransConvert',
           'MRTransformInputSpec', 'MRTransformOutputSpec', 'MRTransform', 'MRRegridInputSpec', 'MRRegridOutputSpec',
           'MRRegrid', 'mask2seedtuple']
...
# Cell
def get_sub_gradfiles(BIDS_layout, sub_dwi):
    """
    For a given layout and a subject's DWI, grab the matching gradient files
    """
    sub_bvec = BIDS_layout.get_bvec(sub_dwi)
    sub_bval = BIDS_layout.get_bval(sub_dwi)
    return (sub_bvec, sub_bval)
